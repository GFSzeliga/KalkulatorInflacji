...
namespace AdventureConsole.Models
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            /*            if (!optionsBuilder.IsConfigured)
                        {
                            //optionsBuilder.UseSqlServer("Data Source=GSZELIGA-NB\\SQLEXPRESS;Initial Catalog=AdventureWorks2019;Integrated Security=True");
                        }*/
